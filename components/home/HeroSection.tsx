    ...
    <section className="py-32 sm:py-48">
      <div className="text-center">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4 sm:mt-16">
          <Link
            href="/blog"
            className="inline-flex items-center justify-center rounded-2xl bg-primary-600 px-8 py-4 text-base font-semibold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-primary-700 hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center rounded-2xl bg-gray-100 px-8 py-4 text-base font-semibold text-gray-900 shadow-sm transition-all hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700"
          >
            🐙 How Compiler works?
          </a>
        </div>

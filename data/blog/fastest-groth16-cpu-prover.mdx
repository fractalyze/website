...
![Runtime Comparison c7g](/blog/groth16-cpu-prover/runtime-comparison-c7g.png)

#### AWS c7a.8xlarge

![Runtime Comparison c7a](/blog/groth16-cpu-prover/runtime-comparison-c7a.png)

#### M4 Pro

![Runtime Comparison M4](/blog/groth16-cpu-prover/runtime-comparison-m4.png)
...
![Performance Breakdown c7g](/blog/groth16-cpu-prover/increment-times-comparison-c7g.png)

![Performance Breakdown c7a](/blog/groth16-cpu-prover/increment-times-comparison-c7a.png)

![Performance Breakdown M4](/blog/groth16-cpu-prover/increment-times-comparison-m4.png)
...
By leveraging [Jordi's Trick], the computation of the polynomial $h(X)$ requires performing the following pattern three times:
...
[CIOS]: https://fractalyze.gitbook.io/primitives/modular-arithmetic/modular-reduction/montgomery-reduction#coarsely-integrated-operands-scanning-cios
[circom-compat]: https://github.com/arkworks-rs/circom-compat
[DIZK]: https://eprint.iacr.org/2018/691.pdf
[efficiently generate Groth16 proofs in distributed environments]: https://fractalyze.gitbook.io/zk/distributed-zk/ryans-trick-for-distributed-groth16
[ffiasm]: https://github.com/iden3/ffiasm
[Gnark]: https://github.com/Consensys/gnark
[HLO]: https://openxla.org/xla/operation_semantics
[ICICLE-Snark]: https://github.com/ingonyama-zk/icicle-snark
[ICICLE-Snark's official benchmark results]: https://github.com/ingonyama-zk/icicle-snark?tab=readme-ov-file#benchmarks
[Jordi's Trick]: https://fractalyze.gitbook.io/zk/snark/groth16#jordis-trick
[MLIR]: https://mlir.llvm.org/
[mul.asm.ejs]: https://github.com/iden3/ffiasm/blob/master/src/mul.asm.ejs
[nasm]: https://www.nasm.us/
[optimization by the Ingonyama team]: https://fractalyze.gitbook.io/primitives/modular-arithmetic/modular-reduction/montgomery-reduction#sos-with-ingonyama-optimization
[Pippenger's algorithm]: https://fractalyze.gitbook.io/primitives/abstract-algebra/elliptic-curve/msm/pippengers-algorithm#total-complexity
[Poseidon2 hash]: https://eprint.iacr.org/2023/323
[RabbitSNARK]: https://github.com/fractalyze/rabbitsnark
[RapidSNARK]: https://github.com/iden3/rapidsnark
[RapidSNARK does]: https://fractalyze.gitbook.io/primitives/abstract-algebra/elliptic-curve/msm/cuzk#approach-1-window-level-parallelism
[RISC0 circuit]: https://github.com/risc0/risc0/blob/1bc05a1/groth16_proof/groth16/risc0.circom
[SOS]: https://fractalyze.gitbook.io/primitives/modular-arithmetic/modular-reduction/montgomery-reduction#separated-operands-scanning-sos
[SPMD]: https://arxiv.org/abs/2105.04663
[term-based parallelization]: https://fractalyze.gitbook.io/primitives/abstract-algebra/elliptic-curve/msm/cuzk#approach-2-thread-level-msm-partitioning
[XLA]: https://openxla.org/xla
[XLA defines and provides a wide range of operation semantics]: https://openxla.org/xla/operation_semantics

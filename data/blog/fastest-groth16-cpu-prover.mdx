...
[HLO](https://openxla.org/xla/operation_semantics) is an **intermediate representation** used in XLA. When users write deep learning models in Python, they are first transformed into HLO, which can then be lowered to MLIR for **machine-dependent optimization**.
...
**[ZKX (ZK Accelerator)](https://github.com/fractalyze/zkx)** is a specialized **ZK runtime compiler** developed by Fractalyze, modeled after XLA.
...
A core component of ZKX is **[ZKIR (ZK Intermediate Representation)](https://github.com/fractalyze/zkir)**.
...
**[RabbitSNARK](https://github.com/fractalyze/rabbitsnark)** is a **Groth16 CPU prover** built using **ZKX and ZKIR**.
...
The circuits used for benchmarking were sourced from [ICICLE-Snark](https://github.com/ingonyama-zk/icicle-snark). We replaced the Keyless circuit with the [RISC0 circuit](https://github.com/risc0/risc0/blob/1bc05a1/groth16_proof/groth16/risc0.circom).
...
By leveraging [Jordi's Trick](https://fractalyze.gitbook.io/zk/snark/groth16#jordis-trick), the computation of the polynomial $h(X)$ requires performing the following pattern three times:

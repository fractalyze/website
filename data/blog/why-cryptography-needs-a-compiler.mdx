...
![ePrint papers matching "zero-knowledge" per year, 2015 to 2026](/blog/why-cryptography-needs-a-compiler/eprint-zk-papers.png)

![Zero-knowledge papers as a share of all ePrint cryptography papers](/blog/why-cryptography-needs-a-compiler/eprint-zk-share.png)

![arXiv papers matching "zero-knowledge" per year](/blog/why-cryptography-needs-a-compiler/arxiv-zk-papers.png)
...
![NVIDIA architecture releases from Kepler to Feynman](/blog/why-cryptography-needs-a-compiler/nvidia-cadence.png)

![CUDA release cadence by major version](/blog/why-cryptography-needs-a-compiler/cuda-releases.png)
...
![SP1's Rust and CUDA directory trees mirroring each other](/blog/why-cryptography-needs-a-compiler/sp1-mirror-tree.png)

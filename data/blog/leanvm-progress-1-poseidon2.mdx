...
1. Compute $v = P + x - y$
2. Apply $\mathsf{reduce}(v)$
3. Compute $v^2$
4. Apply $\mathsf{reduce}(v^2)$
...
This is a Python implementation of [poly/dense.rs](https://github.com/tcoratger/whir-p3/blob/main/src/poly/dense.rs) from WHIR-p3:

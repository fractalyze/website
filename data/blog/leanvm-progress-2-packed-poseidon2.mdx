...
**4. Squared Difference Optimization**

When computing $(a - b)^2$, we can optimize the reduction step as mentioned in our previous report. See [poseidon2-in-mlir](./leanvm-progress-1-poseidon2.mdx#poseidon2-in-mlir) in more details

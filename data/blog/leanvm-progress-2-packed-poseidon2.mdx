...
In our [previous report](./leanvm-progress-1-poseidon2), we showed that our MLIR-based Poseidon2 outperformed Plonky3 on regular PrimeField operations, but lagged behind on Packed PrimeField. This report covers improvements on four major areas:

- [Closing the Packed PrimeField performance gap](#packed-poseidon2-in-mlir)
- [JAX integration for code generation](#jax-integration)
- [ZKX opcode expansion for additional provers](#zkx-opcode-expansion)
- [Pure-JAX Poseidon2 implementation](#poseidon2-in-jax)
...
**1. [Unrolling Square-and-Mul](https://github.com/fractalyze/zkir/pull/86/commits/0f202a7)**
...
This optimization is particularly important in Poseidon2's S-box operation, which computes $x^7$.

**2. [Rewriting Power-of-Two Division](https://github.com/fractalyze/zkir/pull/86/commits/40ab415)**
...
**3. [Removing Redundant Reduction](https://github.com/fractalyze/zkir/pull/86/commits/65aef19)**

When computing modular $(a - b)^2$, we don't actually need to reduce $a-b$'s range from $(-P,P) \rightarrow [0, P)$ since the next operation is squaring. 

**4. [Vector/Tensor Constant Folding](https://github.com/fractalyze/zkir/pull/86/commits/4b67526)**
...
**5. [Specializing for AVX-512](https://github.com/fractalyze/zkir/pull/86/commits/7cc8987)**
...
a * b                    ab_high, ab_low
      \                / 
       a_even * b_even
```
**6. [Specializing for ARM-NEON](https://github.com/fractalyze/zkir/tree/feat/benchmark-arm-neon-poseidon2)**
